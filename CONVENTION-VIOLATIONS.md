...
**Root cause file:**
- [ ] `src/fsd/1-pages/plan-lre/requirement-status-constants.tsx` — convert hex values to CSS tokens

**Consumers (fix after root cause):**
- [ ] `src/fsd/1-pages/plan-lre/le-token-card.tsx` (lines 106, 121)
- [ ] `src/fsd/1-pages/plan-lre/le-token-table.tsx` (lines 235, 244)
- [ ] `src/fsd/1-pages/plan-lre/le-track-battle.tsx`
- [ ] `src/fsd/1-pages/plan-lre/battle-status-checkbox.tsx`
