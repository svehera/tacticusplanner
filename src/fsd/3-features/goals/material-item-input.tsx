...
export const MaterialItemInput: React.FC<Props> = ({ upgradeRaid, isExhausted = false, showBattleInfo, maxLocations = 4 }) => {
                    ...
                    {(expanded ? upgradeRaid.raidLocations : upgradeRaid.raidLocations.slice(0, visibleLocations)).map(
                        location => (
                            <div
                                ...
                                <CompactCampaignLocation location={location} unlocked={true} showBattleInfo={showBattleInfo} />
                            </div>
                        )
                    )}
