...
export const XpTotal: React.FC<IXpEstimate> = ({ books, bookRarity, gold, currentLevel, targetLevel, xpLeft }) => {
    return (
        <div className="flex-box gap5">
            <span>
                <b>{books}</b> {Rarity[bookRarity]} XP Book | <b>{numberToThousandsString(gold)}</b> Gold
            </span>
            <XpTooltip
                books={books}
                gold={gold}
