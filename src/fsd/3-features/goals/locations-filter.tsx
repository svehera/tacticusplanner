...
export const LocationsFilter: React.FC<Properties> = ({ filter, filtersChange }) => {
                ...
                <DialogContent>
                    ...
                    <div className="mt-2.5 flex items-center gap-3">
                        <Autocomplete
                            ...
                            renderInput={parameters => <TextField {...parameters} label="Min Enemy" />}
                        />
                        <Autocomplete
                            fullWidth
                            size="small"
                            ...
                            sx={{ minWidth: 150, maxWidth: 300 }}
                            renderInput={parameters => <TextField {...parameters} label="Max Enemy" />}
                        />
                    ...
                    <MultipleSelectCheckmarks
                        size="small"
                        placeholder="Rarity"
                        selectedValues={currentFilter.upgradesRarity.map(x => RarityMapper.rarityToRarityString(x))}
