...
import { useUnitPortraitAssets } from './unit-portrait.hooks';
import { ISnapshotCharacter, ISnapshotMachineOfWar } from './unit-portrait.model';
...
export const UnitPortrait = ({
    ...
    const renderEquipmentItem = (
        ...
        const equipFrame = frameDetails.file;
