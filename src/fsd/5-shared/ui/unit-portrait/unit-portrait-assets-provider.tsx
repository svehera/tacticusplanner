...
interface UnitPortraitAssetsProviderProps {
    children: React.ReactNode;
}

export const UnitPortraitAssetsProvider: React.FC<UnitPortraitAssetsProviderProps> = ({
    children,
}: UnitPortraitAssetsProviderProps) => {
    ...
    return <UnitPortraitAssetContext.Provider value={value}>{children}</UnitPortraitAssetContext.Provider>;
};
