...
export const tacticusIcons: Record<string, TacticusIcon> = {
    ...
    expeditionSpeedUp: snowprintIcons.expeditionSpeedUp,
    ...
    seasonalEventCurrencySeptember2026: snowprintIcons.seasonalEventCurrencySeptember2026,
    seasonalEventCurrencyCrescendo: snowprintIcons.seasonalEventCurrencyCrescendo,
