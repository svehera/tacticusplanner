    ...
    variants: {
        intent: {
            ...
            warning: [
                ...
                'outline-warning [--btn-bg:var(--btn-warning)] [--btn-border:var(--btn-warning)] [--btn-fg:var(--color-warning-fg)] [--btn-accent:var(--warning-accent)]',
            ...
            success: [
                'outline-success [--btn-bg:theme(--color-success/95%)] [--btn-border:var(--color-success)] [--btn-fg:var(--color-success-fg)] [--btn-accent:var(--success-accent)] dark:[--btn-bg:var(--color-success)]',
            ...
            danger: [
                'outline-danger [--btn-bg:theme(--color-danger/95%)] [--btn-border:var(--color-danger)] [--btn-fg:var(--color-danger-fg)] [--btn-accent:var(--danger-accent)] dark:[--btn-bg:var(--color-danger)]',
