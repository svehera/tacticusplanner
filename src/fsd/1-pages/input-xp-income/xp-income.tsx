                    ...
                    {loopsRaids === 'yes' ? (
                        <>
                            ...
                            <input
                                ...
                                max="15"
                                value={raidLoops}
                                onChange={e => setRaidLoops(Number.parseInt(e.target.value))}
                            ...
                            <input
                                ...
                                onChange={e => setExtraBossesAfterLoop(Number.parseInt(e.target.value))}
                                className="mt-1 w-full accent-orange-500"
                            />
                        </>
                    ) : (
                        <>
                            ...
                            <select
                                value={clearRarity}
                                onChange={e =>
                                    dispatchUpdate('clearRarity', Number.parseInt(e.target.value, 10) as Rarity)
                                }
                            ...
                            <input
                                ...
                                onChange={e => setAdditionalBosses(Number.parseInt(e.target.value))}
                        ...
                        <div className="py-2">
                            ...
                            <div className="flex items-center gap-4">
                                <input
                                    ...
                                    onChange={e => setEliteEnergyPerDay(Number.parseInt(e.target.value))}
                        ...
                        <div className="py-2">
                            ...
                            <div className="flex items-center gap-4">
                                <input
                                    ...
                                    onChange={e => setNonEliteEnergyPerDay(Number.parseInt(e.target.value))}
                                    className="mt-1 w-full accent-yellow-500"
                                />
