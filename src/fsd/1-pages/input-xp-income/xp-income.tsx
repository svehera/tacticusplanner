    ...
    return (
        <div className="mx-auto max-w-2xl rounded-lg bg-white p-5 font-sans text-gray-800 shadow-lg dark:bg-gray-900 dark:text-white">
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
                ...
                <select
                    value={arenaLeague}
                    onChange={({ target: { value } }) => dispatchUpdate('arenaLeague', value as unknown as ArenaLeague)}
                    ...
                    {loopsRaids === 'yes' ? (
                        <>
                            ...
                            <input
                                ...
                                max="15"
                                value={raidLoops}
                                onChange={({ target: { value } }) => setRaidLoops(Number.parseInt(value))}
                            ...
                            <input
                                ...
                                onChange={({ target: { value } }) => setExtraBossesAfterLoop(Number.parseInt(value))}
                                className="mt-1 w-full accent-orange-500"
                            />
                        </>
                    ) : (
                        <>
                            ...
                            <select
                                ...
                                onChange={({ target: { value } }) =>
                                    dispatchUpdate('clearRarity', Number.parseInt(value, 10) as Rarity)
                                }
                            ...
                            <input
                                ...
                                onChange={({ target: { value } }) => setAdditionalBosses(Number.parseInt(value))}
                        ...
                        <div className="py-2">
                            ...
                            <div className="flex items-center gap-4">
                                <input
                                    ...
                                    onChange={({ target: { value } }) => setEliteEnergyPerDay(Number.parseInt(value))}
                        ...
                        <div className="py-2">
                            ...
                            <div className="flex items-center gap-4">
                                <input
                                    ...
                                    onChange={({ target: { value } }) =>
                                        setNonEliteEnergyPerDay(Number.parseInt(value))
                                    }
                                    className="mt-1 w-full accent-yellow-500"
                                />
