...
export const LreAddTeam: React.FC<Properties> = ({
    lre,
    preselectedTrackId,
        ...
        <Dialog open={true} fullWidth onClose={onClose} maxWidth="md" fullScreen={isMobile}>
            ...
            <DialogContent className="pt-2.5">
                <div>
                    ...
                    <div className="flex-box gap10 pt-2.5">
                        <TextField
                            label="Team name"
                            variant="outlined"
                            value={teamName}
                ...
                <div className="flex-box full-width wrap start space-between">
                    ...
                    <div className="min-w-[400px]">
                        ...
                        <div className="flex-box column start max-h-[300px] min-h-[300px] gap-[3px] overflow-auto">
