...
export const TIER_NAME_MAP: Record<number, React.ReactNode> = {
    ...
    3: renderTierLabel(Rarity.Common, 'Stone III+ (Sector Clear)'),
    4: renderTierLabel(Rarity.Uncommon, 'Iron I'),
    5: renderTierLabel(Rarity.Uncommon, 'Iron II'),
    6: renderTierLabel(Rarity.Uncommon, 'Iron III+ (Sector Clear)'),
    7: renderTierLabel(Rarity.Rare, 'Bronze I'),
    8: renderTierLabel(Rarity.Rare, 'Bronze II'),
    9: renderTierLabel(Rarity.Rare, 'Bronze III+ (Sector Clear)'),
    10: renderTierLabel(Rarity.Epic, 'Silver I'),
    11: renderTierLabel(Rarity.Epic, 'Silver II'),
    12: renderTierLabel(Rarity.Epic, 'Silver III+ (Sector Clear)'),
    13: renderTierLabel(Rarity.Legendary, 'Gold I'),
    14: renderTierLabel(Rarity.Legendary, 'Gold II'),
    15: renderTierLabel(Rarity.Legendary, 'Gold III+ (Sector Clear)'),
