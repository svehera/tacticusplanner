        ...
        <Box sx={{ margin: 'auto', padding: 1, paddingBottom: 7 }}>
            ...
            <Paper sx={{ position: 'fixed', bottom: 0, left: 0, right: 0, margin: 'auto' }} elevation={3}>
                <BottomNavigation
                    ...
                    <BottomNavigationAction component={Link} to={'./wyo'} label="Characters" icon={<ListIcon />} />
                    <BottomNavigationAction component={Link} to={'./'} label="Home" icon={<Home />} />
                    <BottomNavigationAction component={Link} to={'./goals'} label="Goals" icon={<TargetIcon />} />
                    <BottomNavigationAction component={Link} to={'./le'} label="Events" icon={<LegendIcon />} />
                </BottomNavigation>
            </Paper>
        </Box>
    );
